        ...
        <div className="py-8 md:flex md:items-center md:justify-between border-b">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <ul className="flex justify-center md:justify-end">
              <li className="mx-3">
              <Link href="https://www.instagram.com/uncluttereddesk" className="text-ligthblack-0 text-opacity-40 hover:text-opacity-100"> <FaFacebook size={25} /> </Link>
              </li>
              <li className="mx-3">
              <Link href="https://www.instagram.com/uncluttereddesk" className="text-ligthblack-0 text-opacity-40 hover:text-opacity-100"> <FaTwitter size={25} /> </Link>
              </li>
              <li className="mx-3">
